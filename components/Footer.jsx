export default function Footer() {
  return (
    <footer className="w-full footer-gradient text-white text-center py-6 mt-10">
      ...
      <div className="flex flex-wrap justify-center gap-4 text-xs text-white/90 mt-2">
        <a href="#" className="underline underline-offset-2 hover:text-white/70">Privacy Policy (US)</a>
        <a href="#" className="underline underline-offset-2 hover:text-white/70">Terms of Service</a>
      </div>
